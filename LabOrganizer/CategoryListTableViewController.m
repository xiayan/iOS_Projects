...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSManagedObject *location = [fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = [location valueForKey:@"reagentType"];
...
{
    CategoryDetailTableViewController *detailViewController = [[CategoryDetailTableViewController alloc] initWithCategory:[fetchedResultsController objectAtIndexPath:indexPath]];

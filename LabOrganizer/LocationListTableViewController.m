...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [location valueForKey:@"place"];
...
{
    LocationDetailTableViewController *detailViewController = [[LocationDetailTableViewController alloc] initWithLocation:[fetchedResultsController objectAtIndexPath:indexPath]];

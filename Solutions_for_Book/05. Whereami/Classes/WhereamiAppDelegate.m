...
{    
    ...
    points[0] = CLLocationCoordinate2DMake(33.81, -84.34);
    points[1] = CLLocationCoordinate2DMake(43.13, -89.33);
...
- (MKOverlayView *)mapView:(MKMapView *)mapView viewForOverlay:(id <MKOverlay>)overlay
{
    ...
    {
        MKCircleView *aView = [[[MKPolylineView alloc] initWithPolyline:(MKPolyline *)overlay] autorelease];
		[aView setStrokeColor:[UIColor redColor]];
		[aView setLineWidth:5];

...
- (id)initWithStyle:(UITableViewStyle)style {
    ...
    if (self) {
        ...
        calculateButton = [[UIBarButtonItem alloc] initWithTitle:@"Calculate" style:UIBarButtonItemStyleBordered target:self action:@selector(quiteEditingMode)];
        ...
        inputButton = [[UIBarButtonItem alloc] initWithTitle:@"Input" style:UIBarButtonItemStyleBordered target:self action:@selector(enterEditingMode)];
